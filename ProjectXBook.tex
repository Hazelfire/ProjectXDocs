...
The interactions lua file has a few new variables that can be used, namely, \texttt{player} and \texttt{tilePos}. \texttt{player} is the player object interacting with the object and \texttt{tilePos} is the name of the tile.
